...
var CostS3 >= 0; # Cost for one unit of cardboard C5 purchased from supplier S3
...
# Assume fixed purchase amount of C5 from S3 = 1000
S3purch_constraint:
	j['C5','S3'] = AvailS3;	
